...
const bt = siteReadme2('buffett-ayaseeri', BUFFETT_CATS, 'buffett-index.json',
  '巴菲特知识库', '镜像自 buffett 站（伯克希尔·哈撒韦股东信、合伙人信、股东大会、访谈与主题解读）。目录结构与网站一致，文件名序号为站内阅读顺序。');
const mg = siteReadme2('munger-ayaseeri', MUNGER_CATS, 'munger-index.json',
...
root += `| duan-ayaseeri/ | 段永平：问答、主题、演讲访谈、人物公司 | 154 |\n`;
root += `| buffett-ayaseeri/ | 巴菲特：股东信、合伙人信、股东大会、访谈、主题解读、关键词、分类 | ${bt} |\n`;
root += `| munger-ayaseeri/ | 芒格：演讲、股东会、致股东信、李录、主题解读、思维格栅、专题 | ${mg} |\n`;
root += `| **合计** | | **${154 + bt + mg}** |\n\n`;
root += `## 目录结构\n\n- **duan-ayaseeri/**：zhuti（主题）/ wenda（问答）/ yanjiang-fangtan（演讲访谈）/ renwu-gongsi（人物公司）\n- **buffett-ayaseeri/**：letters / partner-letters / meetings / interviews / articles/{company,industry,person,question,timeline,category-overview} / keywords / categories\n- **munger-ayaseeri/**：letters / meetings / speeches / li-lu / articles / thinking-grids / topics / guides\n\n各来源子目录详见其 README.md 索引。\n`;
